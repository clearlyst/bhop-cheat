...
void imgui_render::setup_font()
{
	...
	menu::switch_font_cfg(debug_information_flag, c::fonts::debug_information_flag);
	...
	fonts::debug_information_font = ImGui::GetIO().Fonts->AddFontFromFileTTF(fonts::font_directory_debug_information.c_str(), c::fonts::debug_information_size, &debug_information_flag, ImGui::GetIO().Fonts->GetGlyphRangesCyrillic());
...
void imgui_render::setup_menu_style()
{
	...
	style.Colors[ImGuiCol_ActiveElement] = ImColor(menu::menu_accent[0], menu::menu_accent[1], menu::menu_accent[2]);
	style.Colors[ImGuiCol_ActiveTextElement] = ImVec4(255 / 255.f, 255 / 255.f, 255 / 255.f, 255 / 255.f);
	style.Colors[ImGuiCol_HoveringElement] = ImVec4(200 / 255.f, 200 / 255.f, 200 / 255.f, 255 / 255.f);
	style.Colors[ImGuiCol_DisableElement] = ImVec4(30 / 255.f, 30 / 255.f, 30 / 255.f, 255 / 255.f);
